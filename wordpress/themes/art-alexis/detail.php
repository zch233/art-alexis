...
// Existing Current Works matches the grid variant in the export. No data migration.
$grid=$is_collection && apply_filters('art_alexis_collection_grid',$p->post_name==='current-works',$p);
?>
