...
if(is_404()){
    ...
    ?><section class="hero"><div class="hero-shell"><div class="hero-grid"><div class="hero-title"><h1><?php echo esc_html($s['brand']); ?></h1></div><div class="hero-empty" aria-hidden="true"></div><div class="hero-subtitle"><p><?php echo esc_html($s['subtitle']); ?></p></div><a class="hero-scroll" href="#about" aria-label="Explore the page"><?php echo alexis_icon('down'); ?></a></div></div></section>
