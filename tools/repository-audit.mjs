...
const files=[...new Set(execFileSync('git',[...args,'ls-files','--cached','--others','--exclude-standard','-z'],{cwd:root}).toString().split('\0').filter(Boolean))];
const forbidden=/\.(jpe?g|png|webp|gif|avif|psd|sql|sqlite3?|zip|tar|gz|bak)$/i;
