...
const values={COMPOSE_PROJECT_NAME:'art-alexis-vps-check',SITE_ADDRESS:'http://127.0.0.1',SITE_URL:'http://127.0.0.1:9402',ACME_EMAIL:'test@example.com',ADMIN_LOGIN:'siteadmin',ADMIN_EMAIL:'admin@localhost.test',EDITOR_EMAIL:'editor@localhost.test',RELEASE_DIR:resolve('dist',releases.at(-1)).replaceAll('\\','/'),HTTP_BIND:'127.0.0.1:9402',HTTPS_BIND:'127.0.0.1:9443',WORDPRESS_IMAGE:'wordpress:php8.3-apache'};
